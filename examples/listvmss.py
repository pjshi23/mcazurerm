...
# list the VMs 
vmsslist = mcazurerm.list_vmss_sub(access_token, subscription_id)
...
for rg in resource_groups["value"]:
    rgname = rg["name"] 
    vmsslist = mcazurerm.list_vmss(access_token, subscription_id, rgname)
    for vmss in vmsslist['value']:
        ...
        for vm in vms['value']:
            vmid = vm['instanceId']
            vmnic = mcazurerm.get_vmss_vm_nics(access_token, subscription_id, rgname, name, vmid)
...
#startoutput = mcazurerm.start_vmss(access_token, subscription_id, 'guydock3', 'guydock3')
# print(startoutput)

# scaleoutput = mcazurerm.scale_vmss(access_token, subscription_id, 'guydock3', 'guydock3', 'Standard_A1', 'Standard', 5)
# print(scaleoutput)
'''
