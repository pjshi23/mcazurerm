...
def scale_event(scaleNum, access_token):
    ...
    scaleoutput = mcazurerm.scale_vmss(access_token, subscription_id, rgname, vmssname, 'Standard_A1', 'Standard',
                                     newCapacity)
    print(scaleoutput)
...
vmssget = mcazurerm.get_vmss(access_token, subscription_id, rgname, vmssname)
