...
auto_settings = mcmcazurerm.list_autoscale_settings(access_token, subscription_id)
# print(auto_settings)
...
for rg in resource_groups["value"]:
    rgname = rg["name"]
    insights_comp = mcmcazurerm.list_insights_components(access_token, subscription_id, rgname)
